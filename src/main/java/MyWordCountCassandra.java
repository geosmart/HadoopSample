 ...
 */
public class MyWordCountCassandra extends Configured implements Tool
{
    ...
    public int run(String[] args) throws Exception
    {
        ...
        job.setJarByClass(MyWordCountCassandra.class);
       ...
       /* ConfigHelper.setInputRpcPort(job.getConfiguration(), "9160");
        ConfigHelper.setInputInitialAddress(job.getConfiguration(), "192.168.0.1");
        ...
        ConfigHelper.setOutputInitialAddress(job.getConfiguration(), "192.168.0.1");
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        ToolRunner.run(new Configuration(), new MyWordCountCassandra(), args);
        System.exit(0);
    }    
}
