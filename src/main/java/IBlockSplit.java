...
public class IBlockSplit implements InputFormat<LongWritable,Text>
{
	...
	/*
	 *  file name can't start with '_' or '.'
	 */
	...
	/*
	 * getRecordReader and getSplits function must be override
	 */
	@Override
	public RecordReader<LongWritable,Text> getRecordReader(InputSplit split, 
			JobConf job,
			Reporter reporter) throws IOException {
		System.out.println("come into getRecordReader");
...
//		NetworkTopology cluseterMap = new NetworkTopology();
	...
	/*
	 * get input path array from "mapred.input.dir"
	 */
