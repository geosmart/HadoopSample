...
/**
 * Implementation of RecordReader<K,V> has responsibility of reading data 
 * for Map object based on matedata of data stored in InputSplit object
 */
public class MyRecordReader implements RecordReader<LongWritable, Text> {
	...
	private String[] DataStoredDevice = new String[]{"A","B","C","D","D"};
	...
	/*
	 * if you have open a file or other connect with DB and so on,
	 * you can close at close funtion
	 */
	@Override
	...
	/*
	 * Get next data for map input
	 * here directly read data from a string array {new String[]{"A","B","C","D","D"}}.
